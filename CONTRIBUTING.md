...
`decima` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/decima
[issue tracker]: https://github.com/<USERNAME>/decima/issues
