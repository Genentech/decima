...
module_dir = os.path.join(__location__, "../src/decima")
try:
...
try:
    from decima import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "decima Documentation", "Gokcen Eraslan", "manual")
]
