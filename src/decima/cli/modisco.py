...
@click.option("--tss-distance", type=int, default=10_000, show_default=True, help="TSS distance for the prediction.")
@click.option("--model", type=int, default=0, show_default=True, help="Model to use for the prediction.")
...
@click.option(
    "--seqlet-flank-size", type=int, default=5, show_default=True, help="Flank length added to each extracted seqlet."
)
@click.option(
    "--initial-flank-to-add", type=int, default=10, show_default=True, help="Extra flank added when polishing patterns."
)
